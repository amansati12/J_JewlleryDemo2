...
<section class="page-hero compact-hero" style="background-image: linear-gradient(90deg, rgba(9,7,4,.86), rgba(9,7,4,.35)), url('{{ "/assets/images/gold-necklace.jpg" | absolute_url }}');">
  <div class="container">
      ...
      {% for card in cards %}
        ...
        <div class="col-md-6 col-lg-4 reveal">
          <article class="lux-card product-card">
            <img src="{{ data[1] | absolute_url }}" alt="{{ data[0] }} at Aurelia Jewels">
            <div class="card-body">
              <h2>{{ data[0] }}</h2>
              <p>{{ data[2] }}</p>
              <a href="{{ '/contact/' | absolute_url }}">Inquire Now</a>
            </div>
          </article>
        </div>
      {% endfor %}
